  ...
  return (
    <section id="top" className="relative flex min-h-screen flex-col justify-center px-5 pt-24">
      <div className="mx-auto w-full max-w-6xl">
        ...
        <a
          href="#builder"
          className="mt-10 inline-flex items-center gap-3 border border-gold-deep px-8 py-4 font-sans text-[11px] tracking-luxe text-gold-deep transition-colors hover:bg-gold-deep hover:text-ivory dark:border-gold dark:text-gold dark:hover:bg-gold dark:hover:text-night"
        >
